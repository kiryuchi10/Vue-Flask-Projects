...
def make_eda_plots():
    ...
    plot_emotions.figure.savefig(
        "./speech_emotion_recognition/images/plot_emotions.png"
    )
    plot_intensity = sns.countplot(
        x="intensity", data=df, color="lightseagreen", ax=ax
    ).set_title("RAVDESS Audio Dataset")
    plot_intensity.figure.savefig(
        "./speech_emotion_recognition/images/plot_intensity.png"
    )
    plot_gender = sns.countplot(
        x="gender", data=df, color="lightseagreen", ax=ax
    ).set_title("RAVDESS Audio Dataset")
    plot_gender.figure.savefig("./speech_emotion_recognition/images/plot_gender.png")
